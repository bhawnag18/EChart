...
const EChart = () => {
  ...
  const getData1 = () => {
    ...
    var total1 = 0;
    data.map((elem, i) => {
      if (elem.Alcohol == "1") total1 = total1 + 1;
  ...
  const getData2 = () => {
    ...
    var total2 = 0;
    data.map((elem, i) => {
      if (elem.Alcohol == "2") total2 = total2 + 1;
  ...
  const getData3 = () => {
    ...
    var total3 = 0;
    data.map((elem, i) => {
      if (elem.Alcohol == "3") total3 = total3 + 1;
  ...
  const option2 = {
    ...
    xAxis: {
      ...
      axisLabel: {
        interval: 0,
        rotate: 30, //If the label names are too long we can manage this by rotating the label.
        fontSize: 9,
      },
  ...
  return (
    ...
    <div className="main">
        <div className="maini">
      <div className="first">{yAxis && <ReactEcharts option={option} />}</div>
      <div className="second">{result1 && result2 && <ReactEcharts option={option2} />}</div>
      </div>
    </div>
    </>
  );
