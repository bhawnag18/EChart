...
//   console.log(result2,'result2222');
...
//       if(elem.Alcohol=='1')
//         total1=total1+1;
//         count1=count1+elem['Malic Acid']
//     })
//     var result1=count1/total1;
//     yAxis.push(result1);
   
//     console.log(yAxis,'ya')
...
//       if(elem.Alcohol=='2')
//         total2=total2+1;
//         count2=count2+elem['Malic Acid']
//     })
//     var result2=count2/total2;
//     yAxis.push(result2);
//     // setYAxis([...yAxis,result2]);
...
//       if(elem.Alcohol=='3')
//         total3=total3+1;
//         count3=count3+elem['Malic Acid']
//     })
//     var result3=count3/total3;
//     yAxis.push(result3);
   
//   }
  

//   const[Yaxis1,setYaxis1]=useState(yAxis);
  
//   var length1=0,length2=0,length3=0;
//   var r1=0,r2=0,r3=0,s1=0,s2=0,s3=0;
...
//    const showResult=()=>{
//      r1=d3.sum(a1);
//      var rr1=r1.toFixed(2);
//      console.log(r1,'r1111111');
//      r2=d3.sum(b1);
//      var rr2=r2.toFixed(2);
//      console.log(r2,'r222222');
//      r3=d3.sum(c1);
//      var rr3=r3.toFixed(2);
//      console.log(r3,'r3333')
//      result1.push(rr1);
//      result1.push(rr2);
//      result1.push(rr3);
...
//      s1=d3.sum(a2);
//      var ss1=s1.toFixed(2);
//      console.log(s1,'r1111111');
//      s2=d3.sum(b2);
//      var ss2=s2.toFixed(2);
//      console.log(s2,'r222222');
//      s3=d3.sum(c2);
//      var ss3=s3.toFixed(2);
//      console.log(s3,'r3333')
//      result2.push(ss1);
//      result2.push(ss2);
//      result2.push(ss3);
...
//     series: [
//       {
//         data: [39.22220338983049, 32.59309859154928, 48.21062499999997],
//         type: "bar",
//         showBackground: true,
//         itemStyle: {
//           color: "#ffcf7d",
...
//     xAxis: {
//       data: result1,
//       name:'Average of Color Intensity',
//       type:'category',
//       axisLabel: {
//         interval: 0,
//         rotate: 30, //If the label names are too long you can manage this by rotating the label.
...
//       <div>
//       {
//       yAxis && <ReactEcharts option={option} />
//     }
//     </div>
//      <div>
//      {
//        result1 && result2 && <ReactEcharts option={option2} />
//     }
